  ...
  const faqs = [
    {
      ...
      answer: "Any second-year student passionate about technology, development, or community work can apply. You don’t need to be an expert — just have the willingness to learn and contribute."
    },
    {
